...
import { Bell, BookOpen, CircleHelp, Download, KeyRound, LayoutDashboard, LibraryBig, LogIn, Menu, Search, ShieldCheck, Users } from "lucide-react";
...
export function WorkspaceFrame({ area }: { area: "app" | "admin" }) {
  ...
  const items = admin
    ...
    : [["/app", "My workspace", LayoutDashboard], ["/app/research", "My research", LibraryBig], ["/app/access", "Access requests", KeyRound], ["/app/documentation", "Documentation", BookOpen]];
